...
import (
	...
	"github.com/gc2321/my-grpc-proto/protogen/go/hello"
)
...
func (a *GrpcAdapter) SayManyHellos(req *hello.HelloRequest,
	stream hello.HelloService_SayManyHellosServer) error {
	for i := 0; i < 10; i++ {
		greet := a.helloService.GenerateHello(req.Name)
